...
from dashboard.dashboard_util import get_backtest_cards, get_trade_table, get_trade_rows, get_portfolio_cards, get_charts_html, get_html
...
portfolio_cards = get_portfolio_cards(days_candle_data)
